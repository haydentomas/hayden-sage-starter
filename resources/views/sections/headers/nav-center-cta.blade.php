    ...
    <nav id="navbar1" class="sm-navbar flex w-full items-center justify-between gap-6">
      ...
      <div class="header-cta-desktop shrink-0 hidden lg:block">
        <a
          ...
          class="header-cta inline-flex items-center rounded-full px-5 py-2 text-sm font-sans font-semibold uppercase
                 no-underline bg-primary text-white hover:bg-primary/90
